...
main <- function() {
  ...
  table_clean <- lapply(table_list, format_tables, 
                        datadir = datadir, data_version = data_version)
  
  table_final <- Reduce(function(x,y) merge(x,y, all = T, 
                                            by = 'countyfips'), table_clean)
  
  table_final[, c('urb_share2010','white_share2010', 'black_share2010', 
                  'hisp_share2010', 'asian_share2010', 'natam_share2010', 
                  'child_share2010', 'teen_share2010', 
                  'youngadult_share2010', 'adult_share2010', 'elder_share2010', 
...
format_tables <- function(x, datadir, data_version) {
  ...
  make_geo <-  function(y) {
    ...
    y[, c('countyfips') := list(paste0(str_pad(STATEA, 2, pad = "0"),
  ...
  if (x == "ds172_2010_county.csv") {
    ...
    data[ , 'pop2010' := H7V001]
    data[ , c('urb_share2010', 'urb_share2010D') := 
            list(H7W002, H7W001)]
    ...
    data[, c('child_share2010',      #0-14
             ...
             'elder_share2010', 
             'age_share2010D') :=   #65-
           list((H76003 + H76004 + H76005 + 
                   H76027 + H76028 + H76029), 
                (H76006 + H76007 + H76008 + H76009 + H76010  +
                   H76030 + H76031 + H76032 + H76033 + H76034), 
                (H76011 + H76012 + H76035 + H76036), 
                (H76013 + H76014 + H76015 + H76016 + H76017 +
                   H76018 + H76019 + H76037 + H76038 + H76039 + 
                   H76040 + H76041 + H76042 + H76043),
    ...
    data[, 'workers_prsal20105' := QX5E004 + QX5E005 + QX5E006 + 
           QX5E014 + QX5E015 + QX5E016]
    ...
    data[, c('college_share20105', 'college_share20105D') := 
           list((QUSE021 + QUSE022 + QUSE023+ QUSE024 + QUSE025), QUSE001)]
    ...
    data[, c('employee_share20105', 'employee_share20105D') := 
           list((QX5E004 + QX5E014 + QX5E006 + QX5E016 + QX5E007 + QX5E008 + QX5E009 + QX5E017 + QX5E018 + QX5E019),QX5E001)]
