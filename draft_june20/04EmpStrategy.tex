...
\subsubsection{An event-study with one event per zipcode}
    ...
    % NOTE: I also want to say here that data are better quality close to the end of the panel. However, this may rise other measurement error issues, right?
...
\subsubsection{Identification issues}
    ...
    %% DO WE? Revisit last sentence in light or results.
