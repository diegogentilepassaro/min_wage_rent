\begin{table}[hbt!] \centering
    ...
    \begin{tabular}{@{}lcc@{}}
        ...
        Residence minimum wage $\mw^{\res}_{it}$    &  -0.0448   &  -0.0202              \\
                                                    & (0.1735)  & (0.0200)             \\
        Workplace minimum wage $\mw^{\wkp}_{it}$    &  0.0386   &  0.0683              \\
                                                    & (0.2022)  & (0.0307)             \\ \midrule
        County-quarter economic controls            &  Yes   &  Yes              \\
        P-value autocorrelation test                &        &  $<0.0001$        \\
        R-squared                                   &  0.9925   &  0.0216              \\
        Observations                                &  78,995  &  77,567             \\ \bottomrule
    \end{tabular}
