\begin{figure}[h!]
    ...
    \begin{subfigure}{0.75\textwidth} \centering
        ...
        \includegraphics[width = .85\textwidth]{counterfactuals/output/hist_rho_with_imputed_fed_9usd}
    \end{subfigure}

    \begin{subfigure}{0.75\textwidth} \centering
        \caption{Increase in Chicago MW to \$14, Chicago-Naperville-Elgin CBSA}
        \includegraphics[width = .85\textwidth]{counterfactuals/output/hist_rho_with_imputed_chi14}
    \end{subfigure}
