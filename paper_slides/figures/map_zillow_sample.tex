\begin{figure}[h!]
    ...
    \begin{minipage}{.95\textwidth} \footnotesize
        ...
        The figure compares the sample of ZIP codes available in Zillow to
        population density at the ZIP code level.
        The top figure shows the sample of the ZIP codes that have rents data in 
        the SFCC category at any point in the period 2010--2019.
        The bottom figure shows quintiles of population density according to the
