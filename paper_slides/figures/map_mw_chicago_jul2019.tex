\begin{figure}[h!]
    \centering
    \caption{Changes in MW measures in the Chicago-Naperville-Elgin CBSA, July 2019}
    ...
    \begin{subfigure}{0.5\textwidth}
        ...
        \includegraphics[width = 1\textwidth]
            {maps_events/output/chicago_2019-6_actual_mw}
    \end{subfigure}%
    \begin{subfigure}{0.5\textwidth}
        \centering
        \caption{Workplace MW}
        \includegraphics[width = 1\textwidth]
            {maps_events/output/chicago2019-6_exp_mw}
    \end{subfigure}
    ...
    \begin{minipage}{.95\textwidth} \footnotesize
        ...
        \ref{sec:mw_construction} and from LODES \parencite{CensusLODES}.
