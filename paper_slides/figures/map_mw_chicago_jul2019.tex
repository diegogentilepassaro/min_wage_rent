\begin{figure}[h!]
    ...
    \begin{subfigure}{0.5\textwidth}
        ...
        \includegraphics[width = 1\textwidth]
            {maps_events/output/chicago_2019-6_statutory_mw_png}
    \end{subfigure}%
    \begin{subfigure}{0.5\textwidth}
        \centering
        \caption*{Workplace MW}
        \includegraphics[width = 1\textwidth]
            {maps_events/output/chicago2019-6_wkp_mw_png}
    \end{subfigure}
    ...
    \begin{minipage}{.95\textwidth} \footnotesize
        ...
        Smaller colored polygons correspond to ZIP codes, and larger polygons 
