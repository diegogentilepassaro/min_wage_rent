\begin{figure}[h!]
    ...
    \begin{minipage}{.95\textwidth} \footnotesize
        ...
        Surveys described in Section \ref{sec:data_income_housing}.
        ...
        income by SMSA, the closest analogue of CBSA available in the
        data.
        Second, we construct deciles of the residualized household
        income variable.
        Finally, we take the average of the residualized y-variable
        within each decile.
        The sample of individuals includes those living households with
