\begin{figure}[h!]
    \centering
    \caption{Estimates of the landlord share by the relative increase in workplace
             to increase in residence MW, urban ZIP codes}
    ...
    \begin{minipage}{.95\textwidth} \footnotesize
        ...
        The figure shows the average estimate of $\rho_i$ for each decile of 
        the gap $\Delta \mw_i^{\wkp} - \Delta \mw_i^{\res}$.
