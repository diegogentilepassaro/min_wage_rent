\begin{figure}[htb!]
    ...
    \begin{subfigure}{0.5\textwidth}
        ...
        \includegraphics[width = 1\textwidth]{non_parametric/output/cbsa_month_mw_res.pdf}
    \end{subfigure}%
    \begin{subfigure}{0.5\textwidth}
        \caption*{Workplace MW}
        \includegraphics[width = 1\textwidth]{non_parametric/output/cbsa_month_mw_wkp.pdf}
    \end{subfigure}\\
    ...
    \begin{subfigure}{0.5\textwidth}
        \caption*{Residence MW}
        \includegraphics[width = 1\textwidth]{non_parametric/output/cbsa_month_mw_res_resid_mw_wkp_dec.pdf}
    \end{subfigure}%
    \begin{subfigure}{0.5\textwidth}
        \caption*{Workplace MW}
        \includegraphics[width = 1\textwidth]{non_parametric/output/cbsa_month_mw_wkp_resid_mw_res_dec.pdf}
    \end{subfigure}
