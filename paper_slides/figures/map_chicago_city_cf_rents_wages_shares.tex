\begin{figure}[h!]
    ...
    \label{fig:map_chicago_city_cf_rents_wages_shares}

    \begin{subfigure}{.47\textwidth}
        \caption*{Share of additional income pocketed by landlords}
        \includegraphics[width = 1\textwidth]
            {counterfactuals/output/chicago_rho_with_imputed_chi14.png}
    \end{subfigure}\\
    ...
    \begin{minipage}{.95\textwidth} \footnotesize
        ...
        The computations are based on a counterfactual increase to \$14 in the 
        Chicago City MW in January 2020, holding constant other MW policies in their 
