...
\frametitle{A motivating example}
    \begin{columns}
        ...
        \begin{column}{0.6\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics[scale = 0.38]{maps_events/output/kc_2018-12_actual_mw.eps}
            \end{figure}   
        \end{column}
    \end{columns}
\end{frame}
...
\frametitle{A motivating example (Continuation)}
    \begin{columns}
        \begin{column}{0.50\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics[scale = 0.36]{maps_events/output/kc_2018-12_actual_mw.eps}
            \end{figure}   
        \end{column}
        \begin{column}{0.50\textwidth}
            \vspace{-4mm}
            \begin{figure}
                \centering
                \includegraphics[scale = 0.36]{maps_events/output/kc2018-12_exp_mw.eps}
            \end{figure}   
        \end{column}
    \end{columns}
\end{frame}
...
\frametitle{Other examples: New York (MW Changes in January 2019)}
    \begin{columns}
        \begin{column}{0.50\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics[scale = 0.36]{maps_events/output/nyc_2018-12_actual_mw.eps}
            \end{figure}   
        \end{column}
        \begin{column}{0.50\textwidth}
            \vspace{-4mm}
            \begin{figure}
                \centering
                \includegraphics[scale = 0.36]{maps_events/output/nyc2018-12_exp_mw.eps}
            \end{figure}   
        \end{column}
    \end{columns}
\end{frame}
...
\frametitle{Other examples: Bay area (MW Changes in January 2019)}
    \begin{columns}
        \begin{column}{0.50\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics[scale = 0.36]{maps_events/output/bay_area_2018-12_actual_mw.eps}
            \end{figure}   
        \end{column}
        \begin{column}{0.50\textwidth}
            \vspace{-4mm}
            \begin{figure}
                \centering
                \includegraphics[scale = 0.36]{maps_events/output/bay_area2018-12_exp_mw.eps}
            \end{figure}   
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}[label = zipcodes_map]
    ...
    \begin{columns}\
        ...
        \begin{column}{0.46\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics[scale = 0.34]{output/USPS_zipcodes_zillow_data.png}
            \end{figure}   
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}
    \begin{figure}
        \centering
        \vspace{-2mm}
        \includegraphics[scale = 0.46]{fd_baseline/output/fd_baseline_exp_ln_mw_17_dynamic.eps}
    \end{figure}   
\end{frame}
