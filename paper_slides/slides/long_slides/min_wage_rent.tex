...
\begin{frame}[label = discuss4]
    ...
    \begin{itemize}
        ...
        households are aware of price differentials in local consumption across neighborhoods.
    ...
    \begin{itemize}
        ...
        a MW increase will increase prices. This will translate into a lower demand for housing 
        if the substitution effect on local demand of housing is smaller than the corresponding income effect. 
        \item A sufficient condition for that is that housing and local consumption are complements. 
        \hyperlink{microfound}{\beamerbutton{Go Back}}
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \input{../../../analysis/tables/output/slides_static.tex}
\end{frame}
...
\begin{frame}[label = robustness_geo]
	...
	\input{../../../analysis/tables/output/slides_static_robust.tex}
...
\begin{frame}[label = robustness_sample]
	...
	\input{../../../analysis/tables/output/slides_static_sample.tex}
