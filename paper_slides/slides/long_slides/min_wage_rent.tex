...
\institute{Brown University $\ \ \ \quad\quad\quad\quad\quad $ Brown University $ \quad\quad\quad\quad$ $ AWS $ }
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.40\textwidth}
            Cook County, IL, raised the statutory MW from \$12 to \$13 in July 2019. In the state of 
        ...
        \begin{column}{0.6\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics[scale = 0.38]{maps_events/output/chicago2019-6_actual_mw.png}
            \end{figure}   
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    in the locations where the MW change happened (Cook County!). 
    
    \pause
    \vspace{3mm}
    
    However, MW workers in Cook County may also live elsewhere in the Chicago metropolitan area. $\to$ 
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.50\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics[scale = 0.36]{maps_events/outputchicago2019-6_actual_mw.png}
            \end{figure}   
        \end{column}
        \begin{column}{0.50\textwidth}
            \vspace{-4mm}
