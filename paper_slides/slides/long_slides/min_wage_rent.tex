...
\begin{frame}[label = discuss4]
	...
	\hyperlink{microfound}{\beamerbutton{Formalizing microfoundation}}  
\end{frame}
...
\begin{frame}
    ...
    \input{../../../analysis/tables/output/slides_counterfactuals.tex}
...
\begin{frame}
	...
	\begin{itemize}
	    \item When studying effects of place-based policies on the housing market it is of first order importance
...
\begin{frame}[label = robustness_exp_mw]
	...
	\input{../../../analysis/tables/output/slides_static_expMW_sensitivity.tex}
