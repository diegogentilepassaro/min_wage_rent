...
\begin{frame}
    ...
    Today, we will focus on a counterfactual increase of the federal MW to \$9. 
...
\begin{frame}
    ...
    \begin{enumerate}
        \item Get an estimate of $h_z$
        \item Use our empirical model to compute $\Delta r_z$
        \item Use an auxiliary model that maps MW changes to nominal income changes to compute $\Delta Y_z$
    \end{enumerate}
