...
Clearly, even within a single zipcode, there could be a great deal of heterogeneity in 
...
non-missing zipcodes, as it covers the most common U.S. rental house types: roughly a third 
...
in the platform for a given zipcode and month. 
...
A second limitation is that Zillow's market penetration dictates the sample of zipcodes 
available. As a result, we observe a selected sample of typically urban zipcodes. We 
...
To construct this measure we need to know, for each zipcode, where workers residing in 
that zipcode work. We obtain this information from the 2017 Longitudinal Employer-Household 
...
date levels from February 2010 to December 2019. Given that zipcodes enter the Zillow data 
...
%% NOTE: Say how many of the MW increases at the zipcode level have valid rents data
...
universe of U.S. zipcodes and for the top 100 U.S. metropolitan areas, respectively. In 
column 3 we show the complete set of zipcodes in the Zillow data. Finally, column 4 shows 
