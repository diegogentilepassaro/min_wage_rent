...
%
% SH: Dropped the below footnote. 
%     I don't think it's a relevant enough detail, 
%     and we already have too many footnotes so we should economize in them!
%
% \footnote{As for condominium and cooperative units we do not know what share 
% of the rentals they account for.}
%
...
% 
% SH: Good idea! I gave this a try in the next sentence.
%     I don't think a lot of detail is necessary since we have a whole section on it!
%
...
% SH: I don't think necessary since this is a minor detail
%     If good, feel free to drop the comment (keeping the link)
%
As a result, we only use MW changes that are binding, meaning that they actually 
modify that maximum.

When restricting to the sample of ZIP codes available in Zillow, and to our 
...
%
% DGP: We should make sure this is the case.
% SH: I think it is. Do you want to confirm by searching for negative MW changes
%     in the baseline panel?
%
...
%% SH: We should document in `/derived/stats/'
