...
$\countyMWeventsUnbal$ county and city-level changes.
%
...
This partially balanced panel contains $\ZIPMWeventsBase$ MW increases, which arise from 
$\stateMWeventsBase$ state-level changes and $\countyMWeventsBase$ county- and city-level changes.
$\ZIPMWeventsFull$ of those changes take place after ZIP codes already entered the panel, 
and thus are used in estimation.
%%
%% DGP: reminder to document these claims.
%%
%
% MG: Check that the above is correct. Should we sum county and
%     local where it says "county-and city-"?
%
