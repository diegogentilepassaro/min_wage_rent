...
given month.
We thus solely rely on pre-trends testing to validate our identification 
assumption.
...
For ZIP codes that have no housing units, such as those corresponding to 
universities, we use a simple average.
