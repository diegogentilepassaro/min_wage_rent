...
\subsubsection{The Residence Minimum Wage}
...
Employment Statistics (LODES). In particular, we use the origin-destination matrix mapping 
...
Survey (ACS) at the ZCTA level. We assign to each ZCTA a USPS Zip code based on the We assign the following characteristics to each ZIP code: population, number of housing units, 
