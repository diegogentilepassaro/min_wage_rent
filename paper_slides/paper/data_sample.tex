...
We also estimate our models changing the set of weights used to construct the 
workplace MW measure by using different years and alternative job categories, 
