...
%%
%% MG: Documented in descriptive/events_count. Reference it here somehow?
%%
...
$\stateMWeventsBase$ state-level changes and $\CityCountyMWeventsBase$ county- and city-level changes.
$\ZIPMWeventsFull$ of those changes take place after ZIP codes already entered the panel, 
and thus are used in estimation.
%
% MG: Check that the above is correct. 
%
