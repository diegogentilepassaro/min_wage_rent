...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Relationship Between Income and Housing in the US}
\label{sec:data_income_housing}

We explore the joint-distribution of income levels and housing choices in the US 
using the American Housing Survey data for 2011 and 2013 \parencite{ahs2020}.
...
surprisingly constant across household income levels among renters.
...
There is considerable variation in housing expenditure over space, but poorer
