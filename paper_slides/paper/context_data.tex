...
census blocks and ZIP codes detailed in Appendix \ref{sec:blocks_to_uspszip}, 
...
Appendix Figure \ref{fig:mw_policies} shows the different levels of the binding
...
We compare households within metropolitan areas.
...
February 2020.
We downloaded the data in January 2020, a month before Zillow removed it from
its website.} 
...
single-family houses and condominium and cooperative units (SFCC).
...
% See footnote 13 in BorusyakHullJaravel2021
...
\footnote{We include six leads and lags of the MW measures in this panel,
