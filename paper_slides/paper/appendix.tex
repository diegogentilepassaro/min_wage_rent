...
We impose that that $H_{it} \leq S_i$ for all $t$, 
...
different specifications of the model given in \ref{eq:wage_level_model}.
...
Our preferred specification in column (3) suggest that a 10 percent increase
in the workplace MW generates a 1.08 percent increase in total wages.
These estimates are consistent to those in \parencite{CegnizEtAl2019}.
...
minimum wage.
Then, \citeauthor{CegnizEtAl2019}'s estimates imply that a 10 percent increase
in the MW will increase total wages by 
...
dividens as dependent variable.
