...
compute their centroids. There are 11,053,116 census blocks.
...
We assign 545,566 census blocks using this spatial match (4.94 percent of the total).
...
identifier. We assign 22,819 blocks using this approach (0.21 percent).
There remain 17,094 unassigned blocks (0.15 percent), which 
we drop from the analysis.
This creates a unique mapping from census blocks to USPS ZIP codes.
There are 11,036,022 census blocks which are assigned to 31,754 USPS ZIP codes,
implying an average of 347.55 census blocks per ZIP code.
