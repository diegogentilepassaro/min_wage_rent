...
\begin{table}[h!]\centering
	...
	\begin{minipage}{\textwidth} \footnotesize
		...
		with $\Delta \ln \underscore{w}_{ic, t-6}$. Column 7 replicates column 7's model while 
		restricting leads of changes in MW to be zero. Standard errors clustered at the state level are
