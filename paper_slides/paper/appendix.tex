...
% DGP: Para diferenciar un elemento generico de los sets Z_0 y Z\Z_0 de los z que aparecen en las sumas yo los llamaria siempre z_0 y z', o algo asi.
\begin{prop}[Identification]\label{prop:did_id}
    ...
    the policy, 
    % DGP: Aca habria que escribr la definicion 1 para que quede claro within que grupo es que se precisa diferential exposure. 
...
\begin{proof}
    ...
    %DGP: Not obvious that the median is the easiest nor the more general way to split.
