...
One challenge of this project is that that data on commuting patterns and 
characteristics of places is aggregated at the level of the 2010 US Census
geographies, i.e., 
census blocks, census tracts, ZCTAs.
...
To overcome this problem we assign variables defined at the level of 2010 census 
geographies to USPS ZIP codes.
We do this exploiting an original correspondece table between census blocks and 
USPS ZIP codes.
We construct this mapping as follows:
(1) we collect the GIS map of census blocks from CITE (YYYY) and compute their 
centroids;
...
Once we constructed the mapping, then assigning variables defined at 2010
Census geographies to USPS ZIP codes is straightforward.
