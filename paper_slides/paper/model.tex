...
markets.
We use the model to motivate our research design and to interpret our empirical
findings.
In particular, the model provides a justification for the workplace MW and 
highlights the importance of controlling for the MW at residence locations.
Our model is static and assumes fixed commuting shares across 
