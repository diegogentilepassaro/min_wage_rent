...
%%% DGP: 1) I mean that if labor is an input but it can be substituted by a robot at no-cost. 
%%%      2) Probably we should give at least a simple example or argument for why the assumption is reasonable. 
...
%%     If good, feel free to delete this note. If not, we can talk in the office tmr!
