...
explained in \autoref{sec:data}, the set of ZIP codes used for estimation is more urban and affluent 
than the average ZIP code. This, in turn, may imply that our estimated effect 
...
results. In this section, we conduct two exercises that test the sensitivity of our results to our 
sample.
