...
\title{Do Minimum Wages Increase Rents? 
	   ...
	   \thanks{We thank John N. Friedman, Matthew Turner, Jesse M. Shapiro, Kenneth Chay, 
...
\begin{abstract}
    ...
    Our baseline empirical approach assumes that unobservable 
    ...
    square foot. We show evidence indicating how the effect is driven by ZIP codes where 
    minimum wage workers reside, with a larger impact in ZIP 
    codes with a high proportion of unemployed, African-American, and younger households. 
    We further create a measure of \textit{experienced minimum wage} keeping track of the 
    difference between residence and workplace location of minimum wage workers. 
    Estimated effects using this measure suggest the presence of income 
    redistribution across ZIP codes, with those in
