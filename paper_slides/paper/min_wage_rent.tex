...
\begin{abstract}
    \noindent
    Many state and substate minimum wage (MW) policies have been recently 
    ...
    We construct a ZIP-code-by-month panel using rents data from Zillow.
    ...
    %%% SH: Should we want to mention the median here?
    %%% 
\end{abstract}
...
\clearpage
\input{../tables/output/static_ab.tex}
\clearpage
