...
\begin{abstract}
    ...
    the minimum wage where the average resident works (the ``workplace MW'') and
    the minimum wage in the location itself (the ``residence MW'').
    ...
    If residence MW also increases by 10 percent, then the increase in 
