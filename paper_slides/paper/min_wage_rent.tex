...
\author{Santiago Hermo \and Diego Gentile Passaro \and Gabriele Borg
        \footnote{Hermo: Department of Economics, Brown University 
...
\begin{abstract}
    ...
    Our baseline results imply that a ZIP code experiencing a 10 percent increase 
    in workplace MW and no change in residence MW will have an increase in rents 
    of $\BetaBase$ percent.
    If the residence MW also increases by 10 percent, then the increase in 
    rents will be lower, equal to $\BetaPlusGammaBase$ percent.
\end{abstract}
