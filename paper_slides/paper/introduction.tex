...
The reason these estimates are lower are two-fold.
...
that is relevant for a ZIP code's wage income.
...
First, while our results highlight the importance of controlling for the MW 
of the location that enacted the policy, data unavailability prevents us 
from further exploring the role of the residence MW.
...
We discuss the consequences of relaxing this assumption for our empirical 
