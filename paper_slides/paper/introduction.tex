...
levels, respectively.
Motivated by the evidence of the effect of MW policies, we assume that MW hikes 
in the workplace increase income and MW hikes in the residence increase local 
prices.%
...
have a similar elasticity of housing with respect to income, the effect of workplace 
MW on log rents can be summarized in a single measure.
