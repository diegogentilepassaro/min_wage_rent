...
tied to a location, and workers may live and work in locations with different 
...
We couple those data with an original panel dataset of statutory MW levels 
...
For complementary analyses, we also collect data on 
...
one fails to detect the effects we estimate, highlighting the importance of the
