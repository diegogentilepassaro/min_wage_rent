...
policies will affect the welfare of households through other markets. The most 
prominent candidate is the housing market, and failing to account for the potential 
effect of MW changes on their rental prices may well lead to inaccurate welfare conclusions.

Given these remarks, we pose the question: to what extent (if any) are local rents 
