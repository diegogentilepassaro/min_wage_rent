...
We find similar results in these exercises as well.
...
We compute a ``share pocketed by landlords'' in each ZIP code, and also
...
We find systematic spatial variation in incidence in both policies,
...
negatively affected by the housing market channel, our estimates suggest that 
such computation should take into account the homeowner status of households.
...
\parencite[e.g.,][]{DubeLindner2021}.
Our contribution is to focus on a less studied channel, the housing market,
and incorporates spillovers across locations
\parencite[as in the recent work by][]{JardimEtAl2022}.
We point out that this channel may erode some income gains of low-wage workers.
We also contribute by developing a novel panel dataset of MW levels at the 
ZIP code level for the entire US.

Second, we contribute to the literature studying the effects of MW policies 
...
First, unlike these papers we differentiate between residence and workplace MW 
levels, incorporating spillovers across regions.
Second, we use data at a more detailed geography and a higher frequency, which
makes the required identification assumptions more plausible.
...
on rents using transaction-level data between 2000 and 2009.
...
within-city transmission of expenditure shocks in Barcelona.
...
both in the context of MW policies \parencite{Kuehn2016, JardimEtAl2022}, 
