...
% MOTIVATION. 
%%% After reading these paragraphs a reader in any field of economics
...
% CHALLENGES
%%%  These paragraphs explain why your research question has not already
...
MW levels.%
\footnote{However, several papers have highlighted that research on the effect 
	of the MW on employment should also account for potential spillovers that 
...
% THIS PAPER
%%% This paragraph states in a nutshell what the paper accomplishes and how.
...
rental price per square foot for listings within a specific ZIP code-month 
for the category Single Family houses, Condominiums, and Cooperative units 
(SFCC).%
