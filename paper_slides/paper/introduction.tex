...
distribution may be smaller if there is a significant pass-through from MW 
changes to prices, including housing.
...
We propose a new model-based estimation approach where rents in each local 
...
a 10 percent increase in the workplace MW (holding constante residence MW) 
increases rents by 0.58 percent (SE=0.28).
A 10 percent increase in the residence MW (holding constante workplace MW) 
