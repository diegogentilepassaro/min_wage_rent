...
county-level economic indicators from the Quarterly Census of Employment and Wages; 
income aggregates at the ZIP code-year level from the IRS; and 
ZIP code level sociodemographic characteristics from the US Census.
...
literature.}
Similarly, several papers study the consequences of MW policies on income 
inequality \parencite[e.g.,]{Lee1999, AutorEtAl2016}.
