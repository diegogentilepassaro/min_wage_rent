...
(XXXX; YYYY).
%%%%
%%  SH: Add cites to US Census Data and ACS, both from US Census Bureau
%%%%
...
while keeping as many ZIP codes in the sample as possible, in our baseline 
analysis we use a partially balanced panel.%
