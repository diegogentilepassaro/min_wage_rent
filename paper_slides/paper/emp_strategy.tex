...
First, we discuss intuitively the variation we use to estimate the effects
of the MW on rents.
...
between rents and the residence MW for places with a similar level of the 
workplace MW.
...
relationship between rents and the workplace MW for places with a similar level 
of the residence MW.

For these slopes correspond to the causal effect of each MW measure on rents 
...
This assumption rules out selection on gains, i.e., it assumes that ZIP codes 
receiving a particular level of the MW measures will experience the same effect 
...
structure, and select so that to rents react differently to the MW in different 
locations with similar levels of the MW measures.
...
identification in the potential outcomes framework of 
Appendix \ref{sec:potential_outcomes}.
