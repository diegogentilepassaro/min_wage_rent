...
Appendix \ref{sec:potential_outcomes} discusses identification of the effect 
of each of the MW-based measures on rents following the potential outcomes
framework developed in \textcite{CallawayEtAl2021}.



%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Parametric empirical model}
