...
One potential concern with the static DiD model, is that, despite controlling for local factors or zipcode-specific 
...
a change in MW. 
%Under the assumption of no pre-trends, we can gain efficiency through estimating a 
