...
Given the place-based nature of MW changes, we expect the effect to be felt in locations where MW workers reside. Based on this insight, we construct an \textit{experienced} MW variable that, for each zipcode, computes a weighted average of the MW in zipcodes where MW workers work. % DESCRIBE MORE
