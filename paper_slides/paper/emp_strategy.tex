...
1) we estimate equation \ref{eq:fd} allowing the time fixed effects to vary
by metropolitan area; and
2) we constructe a ``stacked'' implementation of our model in which we take
6 months of data around MW changes for ZIP codes in CBSAs where some ZIP codes 
did not received a direct MW change, and then estimate equation \ref{eq:fd} on
