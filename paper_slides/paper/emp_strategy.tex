...
\begin{equation}\label{eq:fd_heterogeneity}
    \Delta r_{it} = \delta_t
                  ...
                  + \Delta \varepsilon_{it} ,
\end{equation}
where $I_i$ represents the standardized share of MW workers in a ZIP code.
We conduct a similar heterogeneity exercises with the standardized median household 
income \parencite[ACS;][]{CensusACS}, and with the stadardized share of public housing 
