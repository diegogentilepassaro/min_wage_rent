...
under the assumption that of \textit{strict exogeneity} of both MW variables:
\begin{equation*}\label{eq:strict_exogeneity}
	...
	\end{pmatrix}
\end{equation*}
for all $s\in\{\underline{T}, ..., \overline{T}\}$. That is, we require the 
unobserved shocks to rents to be uncorrelated with past and present values of 
changes in our MW measures.

This assumption has two important implications. First of all, 
