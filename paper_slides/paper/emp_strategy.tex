...
results.\footnote{We can also interpret the absence of pre-trends as a test for anticipatory
	...
	find the interpretation given in the text more palatable, the data do not allow to separate 
	the two.} 
...
%% SH: Following MeerWest here. Document source to back up this claim 
