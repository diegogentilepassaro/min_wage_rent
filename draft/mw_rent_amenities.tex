...
\begin{figure}[h!]
    \centering
    \scalebox{0.45}{
    \includegraphics{../analysis/event_study/output/medrentpricepsqft_sfcc_last_sal_mw_event_rel_months6.png}
    }
...
\begin{figure}[h!]
    \centering
    \scalebox{0.45}{
    \includegraphics{../analysis/event_study_county_quarter/output/medrentpricepsqft_sfcc_last_sal_mw_event_rel_quarters2.png}
    }
...
\begin{figure}[h!]
    \centering
    \scalebox{0.45}{
    \includegraphics{../analysis/event_study/output/medlistingpricepsqft_sfcc_last_sal_mw_event_rel_months6.png}
    }
