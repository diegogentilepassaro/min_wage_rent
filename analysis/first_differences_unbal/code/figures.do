	...
	*cumsum unbalanced 
	...
	preserve
		...
		twoway (scatter b_full at_base, mcol(navy)) (rcap b_full_lb b_full_ub at_base, lcol(navy) lw(thin)) ///
			   ...
			   (line cumsum_base_b at, col(navy)) (line cumsum_base_lb at, col(navy) lw(thin) lp(dash)) (line cumsum_base_ub at, col(navy) lw(thin) lp(dash)) ///
   			   (line cumsum_wgt_b at, col(maroon)) (line cumsum_wgt_lb at, col(maroon) lw(thin) lp(dash)) (line cumsum_wgt_ub at, col(maroon) lw(thin) lp(dash)), ///
			   yline(0, lcol(black)) ///
