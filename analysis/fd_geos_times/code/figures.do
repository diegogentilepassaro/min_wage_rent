...
program main
    ...
    plot_dynamics, model(county_mw_res_only_dynamic) var(mw_res) ///
        legend_var(Residence MW) y_label(`y_label') ///
        color(maroon) symbol(square) ///
        name(fd_mw_res_only_dynamic)
        
    plot_dynamics, model(county_mw_wkp_only_dynamic) var(`mw_wkp_var') ///
    ...
    plot_dynamics_both, model(county_both_mw_wkp_dynamic) dyn_var(`mw_wkp_var') ///
    ...
    plot_dynamics_both, model(county_both_mw_res_dynamic) dyn_var(mw_res) ///
