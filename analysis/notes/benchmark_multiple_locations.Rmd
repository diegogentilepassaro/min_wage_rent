...
and fully differentiate wrt $\ln r_n$, and $\ln w_j$ fro some $j\neq n$ to get
...
We assume that the MW increases marginall in a subset of locations $\mathcal{J}$,
...
and $\ln \underline{w}_j$, $j \in \mathcal{J}$, to get
...
reside in other locations $j \in \mathcal{J}$, the stronger the effect will be.

### 1.2.4. Increase in wages in multiple workplace locations and residence

What if there is a MW increase in locations $j\in \tilde{\mathcal{J}} = 
\mathcal{J} \cup {n}$ from a common level $\underline{w}$. 
...
If we relax the assumption that the MW is the same across places, we can write 
this expression in terms of the MW and the experienced MW.
