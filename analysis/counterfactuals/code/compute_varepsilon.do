...
program main
    ...
    local i = 1
    forval epsilon = 0.06(0.005)0.141 {
        ...
        save "../temp/tot_incidence_`i'.csv", replace
        local i = `i' + 1
    }
    ...
    clear
    forval i = 1/`n' {
        append using "../temp/tot_incidence_`i'.csv"
    }
    export delimited "../output/tot_incidence_var_epsilon.csv", replace
end
