...
\begin{figure}[h!]
    \centering
    \scalebox{0.45}{
    \includegraphics{medrentpricepsqft_sfcc_last_sal_mw_event_rel_months6}
    }
...
\begin{figure}[h!]
    \centering
    \scalebox{0.45}{
    \includegraphics{two_way_rent_sfcc.png}
    }
...
\begin{figure}[h!]
    \centering
    \scalebox{0.45}{
    \includegraphics{medrentpricepsqft_sfcc_last_sal_mw_event_rel_quarters2.png}
    }
...
\begin{figure}[h!]
    \centering
    \scalebox{0.45}{
    \includegraphics{medlistingpricepsqft_sfcc_last_sal_mw_event_rel_months6.png}
    }
